...
export default function Binance(props: SVGProps<SVGSVGElement>) {
    return (
        <svg role="img" viewBox="0 0 633.04 126.61" fill="currentColor" xmlns="http://www.w3.org/2000/svg" {...props}>
            <g fill="#f3ba2f">
